...
<head>
    ...
    <link rel="shortcut icon" href="./assets/img/vhoster.jpg" type="image/x-icon">
                                    ...
                                    <form class="user" method="post" action="proses-login.php">
                                        ...
                                        if (isset($_GET['pesan'])) {
                                            if ($_GET['pesan'] == "gagal") {
                                                ...
                                                echo '<div class="alert alert-warning" role="alert">Anda harus login untuk mengakses backend!</div>';
                                            }
                                        }
                                        ?>
