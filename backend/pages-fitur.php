        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="form/about/fitur/form_edit.php?id=<?= $row['id'] ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"> Edit</i></a>
                                            <a href="form/about/fitur/hapus.php?id=<?= $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Yakin Hapus?')"><i class="far fa-trash-alt"> Hapus</i></a>
                                        </td>
                                    </tr>
                            <?php
                                endwhile;
                    ...
                    <br>
                    <a href="form/about/fitur/form_tambah.php" class="btn btn-secondary"><i class="fas fa fa-plus"> Tambah</i></a>
                </div>
                <!-- /.container-fluid -->
