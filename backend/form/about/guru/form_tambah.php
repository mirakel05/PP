    ...
    <div class="container">
        <form action="aksi_tambah.php" method="POST" enctype="multipart/form-data">
            <form class="row g-3">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Masukan Instagram</label>
                    <input type="text" class="form-control" name="insta" id="exampleFormControlInput1" placeholder="masukan">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Masukan Facebook</label>
                    <input type="text" class="form-control" name="fb" id="exampleFormControlInput1" placeholder="masukan">
                </div>
                <div class="mb-3">
