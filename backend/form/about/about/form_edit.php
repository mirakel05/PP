    ...
    ?>
            ...
            <div class="container">
                <form action="aksi_edit.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" class="form-control" value="<?= $row['id'] ?>" name="id" placeholder="Masukan ">
                    <input type="text" class="form-control" value="<?= $row['alamat'] ?>" name="alamat" placeholder="Masukan ">
                    <br>
                    <label for="exampleInputEmail1" class="form-label">Masukan Nama</label>
                    <input type="text" class="form-control" value="<?= $row['nama2'] ?>" name="nama2" placeholder="Masukan ">
                    <br>
                    ...
                    <br>
                    <label for="exampleInputEmail1" class="form-label">Masukan Keterangan2</label>
                    <input type="text" class="form-control" value="<?= $row['keterangan2'] ?>" name="keterangan2" placeholder="Masukan ">
                    <br>
