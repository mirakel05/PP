...
<body>
    <div class="container">
        <form action="aksi_tambah.php" method="POST" enctype="multipart/form-data">
            <form class="row g-3">
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Masukan Nomer</label>
                    <input type="number" class="form-control" name="nomer" id="exampleFormControlInput1" placeholder="masukan">
                </div>
                <div class="mb-3">
