                    ...
                    <table class="table table-hover my-0" >
                        <thead>
                            <tr>
                                ...
                                <th class="d-none d-xl-table-cell">Nama2</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-xl-table-cell"><?= $row['nama2'] ?></td>
                                        <td class="d-none d-xl-table-cell"><?= $row['keterangan'] ?></td>
                                        <td class="d-none d-xl-table-cell"><?= $row['keterangan2'] ?></td>
                                        <td><img style="width : 100px; height : 100px;" src="form/about/about/file/<?= $row['foto'] ?>" alt=""></td>
                                        <td>
                                            <a href="form/about/about/form_edit.php?id=<?= $row['id'] ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"> Edit</i></a>
                                        </td>
                                    </tr>
                            <?php
                                endwhile;
