                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><img style="width : 100px; height : 100px;" src="form/contact/home/file/<?= $row['foto'] ?>" alt=""></td>
                                        <td>
                                            <a href="form/contact/home/form_edit.php?id=<?= $row['id'] ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"> Edit</i></a>
                                        </td>
                                    </tr>
                            <?php
                                endwhile;
